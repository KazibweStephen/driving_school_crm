...
async def login(data: LoginRequest, db: AsyncSession = Depends(get_db)):
    ...
    return TokenResponse(
        access_token=create_access_token(
            ...
            can_edit_onboarded_clients=user.can_edit_onboarded_clients,
...
async def switch_company(
    ...
    return TokenResponse(
        access_token=create_access_token(
            ...
            can_edit_onboarded_clients=current_user.can_edit_onboarded_clients,
            company_id=company_id_str,
...
async def refresh(data: RefreshRequest, db: AsyncSession = Depends(get_db)):
    ...
    return TokenResponse(
        access_token=create_access_token(
            ...
            can_edit_onboarded_clients=user.can_edit_onboarded_clients if user else False,
            company_id=company_id_str,
            currency=currency,
            permissions=permissions,
